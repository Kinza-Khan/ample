...
class Objects {
	...
	public function create($table, $fields = array()) {
		...
		try {
			...
			echo "Error: " . $e->getMessage(); // Add this to see errors during AJAX submission
			return false;
		}
	}
	...
	{	
		...
		if (in_array($ext, $allowedExt) === true) {
			if ($fileSize <= (1024 * 2) * 1024) {
				...
				$destination = $_SERVER["DOCUMENT_ROOT"] . '/client/fiver/drive/admin/upload/' . $folderPath . '/' . $fileRoot;
