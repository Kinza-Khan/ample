	...
	public function setBarcode($code, $type, $pr='') {
		...
		switch (strtoupper($type)) {
			...
			case 'IMB': { 
				...
				$this->daft = array('D'=>2, 'A'=>2, 'F'=>3, 'T'=>1);
				$arrcode = $this->barcode_imb($code);
				$arrcode['nom-X'] = $xdim ;
				$arrcode['nom-H'] = 3.68;	
				$arrcode['quietL'] = 3.175;	
				$arrcode['quietR'] = 3.175;	
				$arrcode['quietTB'] = 0.711;
				break;
			}
			case 'RM4SCC': { 
				$xdim = 0.508;	
				$bpi = 22;		
				$this->gapwidth =  ((25.4/$bpi) - $xdim)/$xdim; 
				$this->daft = array('D'=>5, 'A'=>5, 'F'=>8, 'T'=>2);
