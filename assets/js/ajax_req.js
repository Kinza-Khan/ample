$("#editCatForm").submit((function (e) {
    ...
    $(document).on("click", "#catagoryDelete_btn", (function (e) {
        e.preventDefault(),
            ...
            confirm("Are You sure want to delete this item?") && $.post("app/action/delete_cat.php", {
                delete_id: $delete_id,
                delete_data: "delete_data"
            }, (function (e) {
                "true" == $.trim(e) ? (alert("data deleted successfull"), location.reload()) : alert("faild to delete data")
            }))
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                "yes" == $.trim(e) ? (alert("Customer Added Successfully"), location.reload()) : alert(e)
            }
        })
        ...
        // Automatically proceed with the AJAX call
        $.ajax({
            type: "POST",
        ...
        e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_member.php", {
            delete_id: $delete_id,
            delete_data: "delete_data"
        }, (function (e) {
            "true" == e ? (alert("data deleted successfull"), location.reload()) : alert(e)
        }))
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                "yes" == $.trim(e) ? (alert("suppliar added successfully."), location.reload()) : alert(e)
            }
        })
        ...
        e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_suppliar.php", {
            delete_id: $delete_id,
            delete_data: "delete_data"
        }, (function (e) {
            "true" == e ? (alert("data deleted successfull"), location.reload()) : alert(e)
        ...
        e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_product.php", {
            delete_id: $delete_id,
            delete_data: "delete_data"
        }, (function (e) {
            "true" == e ? (alert("data deleted successfull"), location.reload()) : alert(e)
        ...
        e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_exCaragroy.php", {
            delete_id: $delete_id,
            delete_data: "delete_data"
        }, (function (e) {
            "true" == e ? (alert("data deleted successfull"), location.reload()) : alert(e)
        ...
        e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_expense.php", {
            delete_id: $delete_id,
            delete_data: "delete_data"
        }, (function (e) {
            "true" == e ? (alert("data deleted successfull"), location.reload()) : alert(e)
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                "yes" == $.trim(e) ? (alert("Expense catagory added successfylly"), location.reload()) : alert(e)
            }
        })
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                "yes" == $.trim(e) ? (alert("Staff added successfully"), $("#adstaffForm")[0].reset()) : alert(e)
            }
        })
        ...
        $.ajax({
            ...
            data: t,
            success: function (e) {
                "yes" == $.trim(e) ? window.location.href = "app/action/logout.php" : alert(e)
            }
        })
    })), $(document).on("click", "#staff_delete_btn", (function (e) {
        e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_staff.php", {
            delete_id: $delete_id,
            delete_data: "delete_data"
        }, (function (e) {
            "true" == $.trim(e) ? (alert("data deleted successfull"), location.reload()) : alert("faild to delete data")
        ...
        confirm("Are You sure want to edit data") ? $.ajax({
            type: "POST",
        ...
        e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_factoryProduct.php", {
            delete_id: $delete_id,
            delete_data: "delete_data"
        }, (function (e) {
            "true" == $.trim(e) ? (alert("data deleted successfull"), location.reload()) : alert("faild to delete data")
